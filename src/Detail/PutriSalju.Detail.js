    ...
    <>
      <div className="hero py-20 bg-base-200">
        <div className="hero-content flex-col lg:flex-row lg:items-start lg:justify">
          ...
          <div className="ml-8">
            <h1 className="text-5xl font-bold">Kue Putri Salju</h1>
            ...
            <div className="mt-2">
              ...
              >
                <option value="Putri Salju | Variant Original | Stok: 10">Putri Salju | Variant Original | Stok: 10</option>
                <option value="Putri Salju | Variant Coklat | Stok: 10">Putri Salju | Variant Coklat | Stok: 10</option>
                <option value="Putri Salju | Variant Pandan | Stok: 10">Putri Salju | Variant Pandan | Stok: 10</option>
              </select>
            </div>
