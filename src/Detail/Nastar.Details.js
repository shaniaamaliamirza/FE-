    ...
    <>
      <div className="hero py-20 bg-base-200">
        <div className="hero-content flex-col lg:flex-row lg:items-start lg:justify">
          ...
          <div className="ml-8">
            <h1 className="text-5xl font-bold">Kue Nastar</h1>
            ...
            <div className="mt-2">
              ...
              >
                <option value="Nastar | Variant Nanas | Stok: 10">Nastar | Variant Nanas | Stok: 10</option>
                <option value="Nastar | Variant Coklat | Stok: 10">Nastar | Variant Coklat | Stok: 10</option>
                <option value="Nastar | Variant Strawberry | Stok: 10">Nastar | Variant Strawberry | Stok: 10</option>
              </select>
            </div>
            ...
            <div className="flex mt-6 space-x-4">
              <button className="btn bg-white text-black border-black"><Link to="/Cart">Tambah ke Keranjang</Link></button> {/* Ubah menjadi putih */}
              <button className="btn bg-white text-black border-black"><Link to="/cart/context">Beli Sekarang</Link></button> {/* Ubah menjadi putih */}
            </div>
          </div>
        </div>
      </div>
