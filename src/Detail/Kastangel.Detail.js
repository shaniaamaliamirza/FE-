    ...
    <>
      <div className="hero py-20 bg-base-200">
        <div className="hero-content flex-col lg:flex-row lg:items-start lg:justify">
          ...
          <div className="ml-8">
            <h1 className="text-5xl font-bold">Kue Kastangel</h1>
            ...
            <div className="mt-2">
              ...
              >
                <option value="Kastangel | Variant Original | Stok: 10">Kastengel | Variant Original | Stok: 10</option>
                <option value="Kastangel | Variant Coklat | Stok: 10">Kastangel | Variant Coklat | Stok: 10</option>
                <option value="Kastangel | Variant Matcha | Stok: 10">Kastangel | Variant Matcha  | Stok: 10</option>
              </select>
            </div>
