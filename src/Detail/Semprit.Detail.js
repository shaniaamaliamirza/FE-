    ...
    <>
      <div className="hero py-20 bg-base-200">
        <div className="hero-content flex-col lg:flex-row lg:items-start lg:justify">
          ...
          <div className="ml-8">
            <h1 className="text-5xl font-bold">Kue Semprit</h1>
            ...
            <div className="mt-2">
              ...
              >
                <option value="Semprit | Variant Original | Stok: 10">Semprit | Variant Original | Stok: 10</option>
                <option value="Semprit | Variant Coklat | Stok: 10">Semprit | Variant Coklat | Stok: 10</option>
                <option value="Semprit | Variant Redvelvet | Stok: 10">Semprit | Variant Redvelvet | Stok: 10</option>
              </select>
            </div>
